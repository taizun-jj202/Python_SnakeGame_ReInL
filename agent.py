...
class Agent :
    ...
    def __int__(self):
        ...
        self.gamma = 0.9125   # discount rate
    ...
    def remember(self,state,action, reward, next_state, done):
        self.memory.append((self,state,action, reward, next_state, done))# popleft if MAX_MEMORY is reached
    def train_long_memory(self):
        ...
        self.trainer.train_step(self, states, actions, rewards, next_states, done)
